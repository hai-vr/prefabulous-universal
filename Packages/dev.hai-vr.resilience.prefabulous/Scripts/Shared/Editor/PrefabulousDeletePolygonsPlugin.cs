...
namespace Prefabulous.Native.Shared.Editor
{
    public class PrefabulousDeletePolygonsPlugin : Plugin<PrefabulousDeletePolygonsPlugin>
    {
        ...
        {
            var deletePolygons = context.AvatarRootTransform.GetComponentsInChildren<PrefabulousDeletePolygons>(true);
            ...
            PrefabulousUtil.DestroyAllAfterBake<PrefabulousDeletePolygons>(context);
        }
