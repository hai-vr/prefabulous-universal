    ...
    public class PrefabulousHaiRecalculateNormalsPlugin : Plugin<PrefabulousHaiRecalculateNormalsPlugin>
    {
        protected override void Configure()
        {
            var seq = InPhase(BuildPhase.Transforming)
                ...
                .AfterPlugin<PrefabulousGenerateBlendshapesFTEPlugin>()
                .AfterPlugin<PrefabulousConvertBlendshapeConventionsPlugin>();
        ...
        {
            var recalculates = context.AvatarRootTransform.GetComponentsInChildren<PrefabulousRecalculateNormals>(true);
            ...
            PrefabulousUtil.DestroyAllAfterBake<PrefabulousRecalculateNormals>(context);
        }
